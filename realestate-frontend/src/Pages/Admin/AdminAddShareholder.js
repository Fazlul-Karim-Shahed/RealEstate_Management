            ...
            <div className='container my-5 px-md-5'>
                <form onSubmit={e => handleSubmit(e)} className='py-5 px-3 bg-white border rounded' action="" method="post">
                    ...
                    <div className="row mx-0 mb-4">
                        <div className="col-md-2"><label className='mt-1 fw-bold' htmlFor="">Project Name: </label></div>
                    ...
                    <div className="row mx-0 mb-4">
                        <div className="col-md-2"><label className='mt-1 fw-bold' htmlFor="">Registration ID: </label></div>
                        <div className="col-md-9"><input placeholder='ie. 1, 2, 3-4, 5' required onChange={e => handleChange(e)} value={state.registrationId} className='form-control' type="text" name='registrationId' id="" /></div>
                    </div>

                    <div className="row mx-0 mb-4">
                        <div className="col-md-2"><label className='mt-1 fw-bold' htmlFor="">Shareholder Name: </label></div>
                        <div className="col-md-9"><input placeholder='ie. Md. Fazlul Karim' onChange={e => handleChange(e)} value={state.shareholderName} className='form-control' type="text" name='shareholderName' id="" /></div>
                    </div>

                    <div className="row mx-0 mb-4">
                        <div className="col-md-2"><label className='mt-1 fw-bold' htmlFor="">Shareholder Photo: </label></div>
                    ...
                    <div className="row mx-0 mb-4">
                        <div className="col-md-2"><label className='mt-1 fw-bold' htmlFor="">Occupation: </label></div>
                        <div className="col-md-9"><input onChange={e => handleChange(e)} value={state.occupation} className='form-control' type="text" name='occupation' id="" /></div>
                    </div>
                    ...
                    <div className="row mx-0 mb-4">
                        <div className="col-md-2"><label className='mt-1 fw-bold' htmlFor="">Tower: </label></div>
                        <div className="col-md-9"><input onChange={e => handleChange(e)} value={state.tower} className='form-control' type="text" name='tower' id="" /></div>
                    </div>

                    <div className="row mx-0 mb-4">
                        <div className="col-md-2"><label className='mt-1 fw-bold' htmlFor="">Unit: </label></div>
                        <div className="col-md-9"><input onChange={e => handleChange(e)} value={state.unit} className='form-control' type="text" name='unit' id="" /></div>
                    </div>

                    <div className="row mx-0 mb-4">
                        <div className="col-md-2"><label className='mt-1 fw-bold' htmlFor="">Flat: </label></div>
                        <div className="col-md-9"><input onChange={e => handleChange(e)} value={state.flat} className='form-control' type="text" name='flat' id="" /></div>
                    </div>

                    <div className="row mx-0 mb-4">
                        <div className="col-md-2"><label className='mt-1 fw-bold' htmlFor="">Amount of Land: </label></div>
                        <div className="col-md-9"><input onChange={e => handleChange(e)} value={state.amountOfLand} className='form-control' type="text" name='amountOfLand' id="" /></div>
                    </div>
